...
class PresentationTable extends Table {
    constructor() {
        super("presentationsTable", "/api/presentations");
...
class PresentationFilterSort extends FilterSort {
    ...
    createBeginDateFilter() {
        ...
        label.innerText = "Начальная дата";
